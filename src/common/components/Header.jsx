        ...
        <>
            <div className='grid grid-cols-3 p-3 '>
                ...
                <div className='md:flex justify-end items-center hidden'>
                    ...
                    <img src='https://tse2.mm.bing.net/th/id/OIP.fqSvfYQB0rQ-6EG_oqvonQHaHa?pid=Api&P=0&h=180' width={"50px"} height={"50px"} style={{borderRadius:"50%"}}/>
            ...
            <nav className=' w-full  bg-gray-900 text-white p-3 md:flex justify-center items-center'>
                <div className='flex justify-between  items-center md:hidden '>
                    ...
                    <div className='absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-lg'>
                        ...
                        <button className='block px-4 py-2 text-sm text-gray-70 text-black'>Logout</button>
